...
StickyWin.UI = new Class({
    ...
    legacy: function () {
        ...
        if (opt.confirmTxt) opt.buttons.push({
            text: opt.confirmTxt, onClick: opt.onConfirm || function () {
            }
        });
        if (opt.closeTxt) opt.buttons.push({
            text: opt.closeTxt, onClick: opt.onClose || function () {
            }
        });
    },
    build: function () {
...
var TabSwapper = new Class({
    ...
    addTab: function (tab, section, clicker, index) {
        tab = document.id(tab);
        clicker = document.id(clicker);
        section = document.id(section);
...
(function () {
    ...
    try {
        StickyWin.Modal.Ajax = new Class(SWA(StickyWin.Modal));
    } catch (e) {
    }
    try {
        StickyWin.PointyTip.Ajax = new Class(SWA(StickyWin.PointyTip));
    } catch (e) {
    }
})();
